    ...
    <section class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
        ...
        <div class="px-4 sm:px-8 py-5 sm:py-6 bg-slate-50 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h3 class="text-xl font-bold text-slate-800 tracking-tight">{{ $t('Notify Users of Update') }}</h3>
            ...
            <div v-if="selectedUsers.length > 0" class="animate-in fade-in slide-in-from-right-4 duration-300">
                <button
                    ...
                    class="inline-flex items-center px-6 py-3 bg-indigo-600 text-white text-xs font-bold uppercase tracking-[0.2em] rounded-xl hover:bg-indigo-700 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-indigo-100 disabled:opacity-50"
                >
        ...
        <div class="p-4 sm:p-8 space-y-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
                ...
                <div class="flex items-center space-x-2">
                    <button
                        ...
                        class="flex items-center space-x-2 px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-widest transition-all border-2 border-slate-200 text-slate-500 hover:bg-slate-100"
                    >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                ...
                >
                    <div class="w-10 h-10 rounded-lg flex items-center justify-center font-bold text-xs transition-all mr-3"
