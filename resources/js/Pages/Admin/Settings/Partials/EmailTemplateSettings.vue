    ...
    <section class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
        ...
        <div class="px-4 sm:px-8 py-5 sm:py-6 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h3 class="text-xl font-bold text-slate-800 tracking-tight">{{ $t('Email Template Customization') }}</h3>
        ...
        <form @submit.prevent="submit" class="p-4 sm:p-8 space-y-8">
            ...
            <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 space-y-4">
                <h4 class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{{ $t('Live Content Preview') }}</h4>
                <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm text-center">
                    <h2 class="text-xl font-bold text-slate-800 mb-2">{{ form.settings.email_template_title || $t('Reports Updated') }}</h2>
                    ...
                    <div class="inline-block px-8 py-3 bg-indigo-600 text-white text-xs font-bold rounded-lg uppercase tracking-widest shadow-lg shadow-indigo-100">
            ...
            <div class="flex justify-end pt-4 border-t border-slate-100">
                <button
                    ...
                    class="inline-flex items-center px-10 py-4 bg-indigo-600 text-white text-xs font-bold uppercase tracking-[0.2em] rounded-xl hover:bg-indigo-700 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-indigo-100 disabled:opacity-30 disabled:grayscale"
                >
