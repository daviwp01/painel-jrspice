                                ...
                                <div class="flex items-center justify-between px-1">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">{{ $t('Define o acesso específico deste usuário aos Dashboards.') }}</p>
                                        </div>
                                    </div>
                                    
                                    <div class="flex items-center">
                                        <span v-if="(!props.user.allowed_pages || props.user.allowed_pages.length === 0) && visibleAllowedCount > 0" class="text-[9px] text-blue-600 font-bold flex items-center bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                                            <AlertCircle class="w-3 h-3 mr-1.5" />
                                            {{ visibleAllowedCount }} {{ $t('SELECTED (DEFAULT)') }}
                                        </span>
                                        <span v-else-if="visibleAllowedCount === 0" class="text-[9px] text-blue-600 font-bold flex items-center bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                                            <AlertCircle class="w-3 h-3 mr-1.5" />
                                            {{ $t('DEFAULT (SYSTEM)') }}
                                        </span>
