                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden transition-all hover:shadow-md">
                        <div class="px-8 py-6 bg-slate-50/50 border-b border-slate-100 flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-slate-800 tracking-tight">{{ $t('Permissions & Status') }}</h3>
                        ...
                        <div class="p-8 space-y-10">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                >
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p class="text-base font-bold text-slate-800 group-hover:text-emerald-700 transition-colors">{{ $t('Active Account') }}</p>
                            ...
                            <div v-if="!form.is_master" class="space-y-6 animate-in fade-in slide-in-from-top-4 duration-500">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span v-if="(!props.user.allowed_pages || props.user.allowed_pages.length === 0) && visibleAllowedCount > 0" class="text-[10px] text-blue-600 font-bold flex items-center bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                                        <AlertCircle class="w-3 h-3 mr-1" />
                                        {{ visibleAllowedCount }} {{ $t('SELECTED (DEFAULT)') }}
                                    </span>
                                    <span v-else-if="visibleAllowedCount === 0" class="text-[10px] text-blue-600 font-bold flex items-center bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                                        <AlertCircle class="w-3 h-3 mr-1" />
                                        {{ $t('DEFAULT (SYSTEM)') }}
                                    </span>
